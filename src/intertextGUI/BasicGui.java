...
public class BasicGui{
    ...
    private JFrame f = new JFrame("Intertext Locator Version 1.uh-oh"); //create Frame
    ...
    public BasicGui(){
        ...
        //mnuItemAbout.addActionListener(new ActionListenerBean ());
        ...
        //f.getContentPane().add(pnlWest, BorderLayout.EAST);
